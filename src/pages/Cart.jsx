...
export default function Cart() {
  ...
  useEffect(() => {
    const fetchCartItems = async () => {
      ...
      try {
        const response = await fetch("http://lasestore.test/api/allproduct");
  ...
  const increaseQuantity = (id) => {
    setProductMatches((prevMatches) =>
      prevMatches.map((item) =>
        item.product_id === id ? { ...item, q: item.q + 1 } : item
      )
    );
                      ...
                      <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                        <Link to="#" className="shrink-0 md:order-1">
                          <img
                            ...
                            src={
                              `http://lasestore.test/${item.product_image}` ||
...
//                               type="button"
//                               id="increment-button"
//                               onClick={() => increaseQuantity(item.produce.product_id)}
//                               data-input-counter-increment="counter-input"
//                               className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
//                             >
//                               <svg
...
//                 <Link
//                   to={`/checkout`}
//                   className="flex w-full items-center justify-center rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-primary-700 dark:focus:ring-blue-800"
//                 >
//                   Proceed to Checkout
//                 </Link>
