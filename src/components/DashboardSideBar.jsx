...
export default function DashboardSideBar() {
  ...
  return (
    <>
      <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 fixed left-0 top-0">
        <a href="#">
          <img
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          ...
          <NavLink href="#" className="flex items-center px-4 -mx-2">
            {/* <img
